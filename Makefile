# Makefile for Cact logd (kernel-message logger daemon)
...
build/logd.o: main.c $(START_O) $(LIBC_SO)
	@mkdir -p build
	$(CC) $(CFLAGS) -c main.c -o $@

$(OUT): build/logd.o $(START_O) $(LIBC_SO)
	@mkdir -p build/sbin
	$(LD) $(LDFLAGS) $(START_O) build/logd.o $(LIBC_SO) -o $@

install: all
	@mkdir -p $(LR_SBIN)
	cp -f $(OUT) $(LR_SBIN)/logd
